...
<body>
    ...
    <!---------------------------------------------------- TEMPLATE ---------------------------------------------------->
    <div id="tree_template" hidden>
        <div class="tree_item">
            <div class="title">
                <span><input type="checkbox" class="title_checkbox" checked></span>
                <button class="title_menu_button"><img src="Hamburger_icon.svg" alt=""></button>
                <div class="tag_name">tag_name</div><div class="short_name">short_name</div>
            </div>
            <div class="attributes">
                <table class="attributes_table">
                    <tbody>
                        <tr class="attribute_item"><td class="attribute_name">attribute_name</td><td class="attribute_value">attribute_value</td></tr>
                    </tbody>
                </table>
            </div>
...
if(chrome.runtime){
    ...
    var filename = document.URL.replace("file://", "");
    var xml_string = document.body.textContent;

    let TEMPLATE_DOM_PARSER = new DOMParser();
    let TEMPLATE_DOM = TEMPLATE_DOM_PARSER.parseFromString(TEMPLATE, "text/html");
    // document.body.insertBefore(TEMPLATE_DOM.children[0], document.body.firstChild);
    document.body = TEMPLATE_DOM.children[0].querySelector("body");
}
...
// Chrome Extension
if(chrome.runtime){
    tree_view = new TreeViewXML("#main", xml_string, {filename});
}